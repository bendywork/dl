...
sentence_file_path = '../../../base/datas/resources/in_the_name_of_people.txt'
word_file_path = '../../../base/datas/resources/cut_words_of_in_the_name_of_people.txt'
model_file_path1 = '../../../base/datas/resources/gensim_word2vec1.w2v'
model_file_path2 = '../../../base/datas/resources/gensim_word2vec2.bin'
model_file_path3 = '../../../base/datas/resources/gensim_word2vec3_{}.npy'
...
model.wv.save_word2vec_format('../../../base/datas/resources/gensim_word2vec2.txt', binary=False) # 以文本方式持久化
...
# 加载模型
model2 = gensim.models.KeyedVectors.load_word2vec_format('../../../base/datas/resources/vectors.bin',
                                                         binary=True)
print(model2)
