...
# 加载词典
jieba.load_userdict('../../../base/datas/resources/word_dict.txt')

# In[ ]:


with open('../../../base/datas/resources/word_dict.txt', 'r', encoding='utf-8') as reader:
    for line in reader:
        print(line.strip())
...
# 设置自定义IDF文件
jieba.analyse.set_idf_path('../../../base/datas/resources/idf.txt.big')
# 设置自定义停止词
jieba.analyse.set_stop_words('../../../base/datas/resources/stop_words.txt')
# 再进行关键词提取
jieba.analyse.extract_tags(sentence,topK=10,withWeight=True, 
                           allowPOS=('n', 'ns','vn', 'a'))
